...
FILE_DESTINATION = "/home/pi/Desktop/437FinalProject/commands.txt"
...
LANG_KEYWORD_RIGHT_SYNONYMS = [ENC_KEYWORD_RIGHT, 'WRITE', 'RITE', 'RATE', 'VOTE']
LANG_KEYWORD_FORWARD_SYNONYMS = [ENC_KEYWORD_FORWARD, 'STRAIGHT', 'STRAIT']
LANG_KEYWORD_BACKWARD_SYNONYMS = [ENC_KEYWORD_BACKWARD, 'BACK', 'REVERSE', 'BACKWARDS']
LANG_KEYWORD_STOP_SYNONYMS = [ENC_KEYWORD_STOP, 'STAY', 'FREEZE', 'IDLE', 'STAND']
